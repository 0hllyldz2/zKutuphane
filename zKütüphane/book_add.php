...
<body>
    ...
    <div class="container mt-5">
            <div class="card"> <br>
                <h1 class="signup-title">Kitap Ekle</h1>
                <form action="operation.php" method="post" class="signup-form">
                    <input type="hidden" name="islem" value="kitap_ekle"> <br>

                    <Label>Kitap Adı</Label>
                    <input type="text" class="form-control" name="kitap_ad" required>

                    <Label>Yazar Adı</Label>
                    <input type="text" class="form-control" name="yazar_adi" required>
                    ...
                    <select class="form-control" name="tur">
                        ...
                        <?php foreach ($kitapturleri as $tur) { ?>
                            <option value="<?=$tur['id']; ?>"><?=$tur['tur_adi']; ?></option>
                      <?php } ?>
                    </select>

                    <Label>Kitabın Stoğu</Label>
                    <input type="text" class="form-control" name="stok" required>

                    <Label>Kitap Durumu</Label>
                    <input type="checkbox" name="durum">

                    <button type="submit" class="btn btn-primary" name="ekle">Ekle</button> <br>
                </form>
            </div>  
        </div>
        <div><br><br></div>
