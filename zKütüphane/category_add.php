...
<body>
    ...
    <div class="container mt-5">
            <div class="card"> <br>
                <h1 class="signup-title">Kitap Türü Ekle</h1>
                <form action="operation.php" method="post" class="signup-form">
                    <input type="hidden" name="islem" value="tur_ekle"> <br>

                    <Label>Türü Ekle</Label>
                    <input type="text" class="form-control" name="tur_adi" required>

                    <Label>Tür Açıklaması</Label>
                    <input type="text" class="form-control" name="tur_aciklama" required>
