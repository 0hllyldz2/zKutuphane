        ...
        <div class="container"> <br>
            <div class="card"> <br>
                ...
                <form action="operation.php" method="post" class="signup-form">
                    ...
                    <label for="first-lastname">Adı Soyadı</label>
                    <input type="text" id="first-lastname" name="ad_soyad" required>
                    ...
                    <button type="submit" class="btn btn-primary" name="kaydol">Kaydol</button> <br>
                </form>
            </div>  
        </div>
        <div><br><br></div>
